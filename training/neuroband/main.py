...
class PlayVae:
    def __init__(self,config):
        ...
        self.instantiate_first_stage(self.config['model']['params']['first_stage_config'])
...
if __name__ == "__main__":
    ...
    # vae = PlayVae('/workspace/data_dir/tmp_dyh/Diff-Foley/training/neuroband/configs/ldm_training/audioldm.yaml')
    # vae.first_stage_model = vae.first_stage_model.to(device)
    # all_latents = []
    # for data_mix in data.train_dataloader():
    #     spec = data_mix['mix_spec']
    #     spec = spec.to(device)
    #     z = vae.enc(spec)
