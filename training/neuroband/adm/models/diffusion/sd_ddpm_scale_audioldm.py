...
class LatentDiffusion(DDPM):
    ...
    def sample_log_diff_sampler(self, cond, batch_size, sampler_name, ddim_steps, size_len=248, unconditional_guidance_scale=1.0,unconditional_conditioning=None, **kwargs):
