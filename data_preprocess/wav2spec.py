...
if __name__ == '__main__':
    input_wav_path = "/workspace/wcp/Diff-Foley/CAVP_eval/sample_0_diff.wav"
    output_npy_path = "/workspace/wcp/Diff-Foley/CAVP_eval/sample_0_diff.npy"
    sr = 16000
    time = 10
    length = sr * time 
    _, mel_spec =get_spectrogram(input_wav_path, length, sr)
    np.save(output_npy_path, mel_spec)
