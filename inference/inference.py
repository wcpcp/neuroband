...
if __name__ == "__main__":
    ...
    config = '/workspace/wcp/Diff-Foley-pub/inference/configs/evaluations/audioldm_large.yaml'
    ...
    # single_test
    example_feat = np.load('/workspace/data_dir/tmp_dyh/Diff-Foley/training/neuroband/visual_tool/comic_video_feat/comic1_clip.npz')['feat'].astype(np.float32)
    ...
    for i in range(inference_time):
        ...
        save_waveform(f'/workspace/data_dir/tmp_dyh/Diff-Foley/training/neuroband/visual_tool/comic_result/test_{seed}.wav',audio_samples,16000)
        # seed += 42
